  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#161613] font-sans text-white antialiased">
        ...
        <main>
          <section className="px-5 pb-20 pt-56 relative min-h-screen">
            <div className="absolute inset-0">
              <div className="w-full h-full absolute inset-0 flex justify-between">
                <div className="w-[4px] bg-transparent"></div>
                {new Array(12).fill(null).map((x) => (
                  <div className="w-[4px] bg-[#333]/10"></div>
                ))}
                <div className="w-[4px] bg-transparent"></div>
              </div>
              <div className="w-full absolute inset-0 h-full flex flex-col justify-between">
                <div className="h-[4px] bg-transparent"></div>
                {new Array(7).fill(null).map((x) => (
                  <div className="h-[4px] bg-[#333]/10"></div>
                ))}
                <div className="h-[4px] bg-transparent"></div>
              </div>
              <div
              ...
              />
              <svg
                className="-ml-20 -mt-20 absolute opacity-40"
                width="792"
                height="527"
                viewBox="0 0 792 527"
                fill="none"
